...
- Use sensible defaults for anything unspecified (reference: stop 45 / target 35 on 3 contracts [$2,700/$2,100 on NQ, ~0.78 R:R], 1 trade/day, 09:30 open, 11:00 cutoff, $2100/$2700 daily caps, 50k eval with +3000 target and 2000 trailing drawdown).
